#line 1 "E:/ITS/Pelajaran/Semester 8/3 - Tugas Akhir/Program_Mikro_Fix/mikromedia_7_STM32F7.c"
#line 1 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/mikromedia_7_stm32f7.h"
#line 1 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/__t_stm32.h"
...
#line 16 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/__t_stm32.h"
...
#line 45 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/__t_stm32.h"
...
#line 83 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/__t_stm32.h"
typedef struct
{
...
#line 39 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/mikromedia_7_stm32f7.h"
...
#line 66 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/mikromedia_7_stm32f7.h"
...
#line 89 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/mikromedia_7_stm32f7.h"
...
#line 105 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/mikromedia_7_stm32f7.h"
...
#line 121 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/mikromedia_7_stm32f7.h"
...
#line 137 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/mikromedia_7_stm32f7.h"
...
#line 153 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/mikromedia_7_stm32f7.h"
extern const T_uart_obj _MIKROBUS5_UART;
#line 175 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/mikromedia_7_stm32f7.h"
extern const uint8_t _LOG_USBUART;
#line 188 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/mikromedia_7_stm32f7.h"
T_mikrobus_ret mikrobus_gpioInit(T_mikrobus_soc bus, T_mikrobus_pin pin, T_gpio_dir direction);
#line 202 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/mikromedia_7_stm32f7.h"
...
#line 1 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/__mm_7_stm32f7_gpio.c"
#line 1 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/__t_stm32.h"
#line 13 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/__mm_7_stm32f7_gpio.c"
...
static T_mikrobus_ret _gpioInit_1(T_mikrobus_pin pin, T_gpio_dir dir)
{
 ...
 case _MIKROBUS_RST_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOC_BASE, _GPIO_PINMASK_11 ); else GPIO_Digital_Output(&GPIOC_BASE, _GPIO_PINMASK_11 ); break;
 ...
 case _MIKROBUS_RX_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOA_BASE, _GPIO_PINMASK_7 ); else GPIO_Digital_Output(&GPIOA_BASE, _GPIO_PINMASK_7 ); break;
 case _MIKROBUS_TX_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOD_BASE, _GPIO_PINMASK_6 ); else GPIO_Digital_Output(&GPIOD_BASE, _GPIO_PINMASK_6 ); break;
 case _MIKROBUS_SCL_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOF_BASE, _GPIO_PINMASK_8 ); else GPIO_Digital_Output(&GPIOF_BASE, _GPIO_PINMASK_8 ); break;
 case _MIKROBUS_SDA_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOF_BASE, _GPIO_PINMASK_9 ); else GPIO_Digital_Output(&GPIOF_BASE, _GPIO_PINMASK_9 ); break;
...
static T_mikrobus_ret _gpioInit_2(T_mikrobus_pin pin, T_gpio_dir dir)
{
 ...
 case _MIKROBUS_INT_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOE_BASE, _GPIO_PINMASK_4 ); else GPIO_Digital_Output(&GPIOE_BASE, _GPIO_PINMASK_4 ) ; break;
 case _MIKROBUS_RX_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOA_BASE, _GPIO_PINMASK_6 ); else GPIO_Digital_Output(&GPIOA_BASE, _GPIO_PINMASK_6 ); break;
...
static T_mikrobus_ret _gpioInit_3(T_mikrobus_pin pin, T_gpio_dir dir)
{
 switch( pin )
 {
 case _MIKROBUS_AN_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOB_BASE, _GPIO_PINMASK_2 ); else GPIO_Digital_Output(&GPIOB_BASE, _GPIO_PINMASK_2 ) ; break;
 ...
 case _MIKROBUS_RX_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOA_BASE, _GPIO_PINMASK_9 ); else GPIO_Digital_Output(&GPIOA_BASE, _GPIO_PINMASK_9 ); break;
...
static T_mikrobus_ret _gpioInit_4(T_mikrobus_pin pin, T_gpio_dir dir)
{
 ...
 case _MIKROBUS_RST_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOF_BASE, _GPIO_PINMASK_14 ); else GPIO_Digital_Output(&GPIOF_BASE, _GPIO_PINMASK_14 ) ; break;
 ...
 case _MIKROBUS_SCK_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOA_BASE, _GPIO_PINMASK_10 ); else GPIO_Digital_Output(&GPIOA_BASE, _GPIO_PINMASK_10 ); break;
 case _MIKROBUS_MISO_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOA_BASE, _GPIO_PINMASK_11 ); else GPIO_Digital_Output(&GPIOA_BASE, _GPIO_PINMASK_11 ); break;
 case _MIKROBUS_MOSI_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOB_BASE, _GPIO_PINMASK_12 ); else GPIO_Digital_Output(&GPIOB_BASE, _GPIO_PINMASK_12 ); break;
...
static T_mikrobus_ret _gpioInit_5(T_mikrobus_pin pin, T_gpio_dir dir)
{
 switch( pin )
 {
 case _MIKROBUS_AN_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOC_BASE, _GPIO_PINMASK_1 ); else GPIO_Digital_Output(&GPIOC_BASE, _GPIO_PINMASK_1 ) ; break;
 case _MIKROBUS_RST_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOF_BASE, _GPIO_PINMASK_15 ); else GPIO_Digital_Output(&GPIOF_BASE, _GPIO_PINMASK_15 ) ; break;
 case _MIKROBUS_CS_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOB_BASE, _GPIO_PINMASK_7 ); else GPIO_Digital_Output(&GPIOB_BASE, _GPIO_PINMASK_7); break;
 case _MIKROBUS_SCK_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOA_BASE, _GPIO_PINMASK_10 ); else GPIO_Digital_Output(&GPIOA_BASE, _GPIO_PINMASK_10 ); break;
 case _MIKROBUS_MISO_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOA_BASE, _GPIO_PINMASK_11 ); else GPIO_Digital_Output(&GPIOA_BASE, _GPIO_PINMASK_11 ); break;
 case _MIKROBUS_MOSI_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOB_BASE, _GPIO_PINMASK_12 ); else GPIO_Digital_Output(&GPIOB_BASE, _GPIO_PINMASK_12 ); break;
 case _MIKROBUS_PWM_PIN : if(dir == _GPIO_INPUT) GPIO_Digital_Input(&GPIOE_BASE, _GPIO_PINMASK_0 ); else GPIO_Digital_Output(&GPIOE_BASE, _GPIO_PINMASK_0 ) ; break;
...
#line 1 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/__mm_7_stm32f7_uart.c"
#line 1 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/__t_stm32.h"
#line 13 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/__mm_7_stm32f7_uart.c"
...
#line 1 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/__mm_7_stm32f7_log.c"
#line 1 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/__t_stm32.h"
#line 13 "e:/its/pelajaran/semester 8/3 - tugas akhir/program_mikro_fix/__mm_7_stm32f7_log.c"
...
#line 38 "E:/ITS/Pelajaran/Semester 8/3 - Tugas Akhir/Program_Mikro_Fix/mikromedia_7_STM32F7.c"
...
#line 143 "E:/ITS/Pelajaran/Semester 8/3 - Tugas Akhir/Program_Mikro_Fix/mikromedia_7_STM32F7.c"
...
#line 162 "E:/ITS/Pelajaran/Semester 8/3 - Tugas Akhir/Program_Mikro_Fix/mikromedia_7_STM32F7.c"
T_mikrobus_ret mikrobus_gpioInit(T_mikrobus_soc bus, T_mikrobus_pin pin, T_gpio_dir direction)
{
 switch( bus )
 {
...
#line 184 "E:/ITS/Pelajaran/Semester 8/3 - Tugas Akhir/Program_Mikro_Fix/mikromedia_7_STM32F7.c"
 default : return _MIKROBUS_ERR_BUS;
 }
 return _MIKROBUS_OK;
}
#line 253 "E:/ITS/Pelajaran/Semester 8/3 - Tugas Akhir/Program_Mikro_Fix/mikromedia_7_STM32F7.c"
T_mikrobus_ret mikrobus_uartInit(T_mikrobus_soc bus, const uint32_t *cfg)
{
 switch( bus )
 {
...
#line 275 "E:/ITS/Pelajaran/Semester 8/3 - Tugas Akhir/Program_Mikro_Fix/mikromedia_7_STM32F7.c"
 default : return _MIKROBUS_ERR_BUS;
 }
 return _MIKROBUS_OK;
}
...
#line 306 "E:/ITS/Pelajaran/Semester 8/3 - Tugas Akhir/Program_Mikro_Fix/mikromedia_7_STM32F7.c"
 case _LOG_USBUART : return _log_initUart( baud );
#line 314 "E:/ITS/Pelajaran/Semester 8/3 - Tugas Akhir/Program_Mikro_Fix/mikromedia_7_STM32F7.c"
 default : return _MIKROBUS_ERR_BUS;
 }
 return _MIKROBUS_OK;
}
